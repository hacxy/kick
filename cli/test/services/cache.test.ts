...
describe('clearTemplateCache', () => {
  ...
  it('should remove cache directory if it exists', async () => {
    ...
    expect(rm).toHaveBeenCalledWith('/home/user/.fe/cache/my-template', {
      recursive: true,
      force: true,
    })
  })
...
describe('copyFromCache', () => {
  ...
  it('should copy from cache to destination', async () => {
    ...
    expect(cp).toHaveBeenCalledWith('/home/user/.fe/cache/my-template', '/dest/path', {
      recursive: true,
    })
  })
})
...
describe('saveToCache', () => {
  ...
  it('should save to cache', async () => {
    ...
    expect(cp).toHaveBeenCalledWith('/src/path', '/home/user/.fe/cache/my-template', {
      recursive: true,
    })
  })
})
