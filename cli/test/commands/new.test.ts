...
describe('createProject', () => {
  ...
  it('should create project successfully', async () => {
    ...
    const { fetchTemplates } = await import('../../services/template.js')
    ...
    const { downloadTemplate } = await import('../../services/download.js')
  ...
  it('should use template from options if provided', async () => {
    ...
    const inquirer = await import('inquirer')
    vi.mocked(inquirer.default.prompt).mockResolvedValueOnce({ projectName: 'my-project' })
